...
const styles = StyleSheet.create({
  ...
  bottom: { width: '100%', alignItems: 'center', gap: 16, paddingHorizontal: 8 },
  btn: { width: '100%', maxWidth: 560, backgroundColor: '#6B4226', paddingVertical: 16, borderRadius: 16, alignItems: 'center' },
